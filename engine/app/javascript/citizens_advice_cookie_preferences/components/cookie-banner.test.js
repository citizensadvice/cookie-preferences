...
beforeEach(async () => {
  const componentHtml = `<div class="cookie-banner js-cookie-banner">
...
test('test', async () => {
  ...
  const confirmationMessage = screen.getByClass('js-cookie-banner__confirmation-message');
  expect(confirmationMessage).toHaveAttribute('hidden', false);
});
